...
namespace Pode
{
    ...
    public static class MimeTypeMap
    {
        ...
        static bool ShouldHaveCharset(string type)
        {
        ...
        public static string GetExtension(string mimeType, bool defaultIsNull = false, bool addCharSet = false, bool throwErrorIfNotFound = false)
        {
            ...
            {
                if (addCharSet && ShouldHaveCharset(mimeType))
                    return $"{extension}; charset=utf-8";
